...
<div class="adminContents">
    <form name="memberForm" id="memberForm" method="post" action="/cms/banner/modify/${banner.id}" enctype="multipart/form-data">
        <table class="normalBoardWr">
            ...
            <tr>
                <th > url </th>
                <td >
                    <input type="text" name="url" value="${banner.url}" id="url" value="">
                </td>
            </tr>
            ...
            <tr>
                <th>메모</th>
                <td>
                    <input type="text" name="memo" value="${banner.memo}" id="memo" value="">
                </td>
            </tr>
        ...
        <div class="buttonArea02">
            ...
            <button type="submit" class="button01">수정하기</button>
