...
<form id="reserveForm" name="reserveForm" onsubmit="return chkForm();" method="post" action="<c:url value="/reservation"/>">
    <input type="hidden" name="sDupInfo" value="${sDupInfo}">
    <input type="hidden" name="gender" value="${sGender % 2 eq 0 ? "여" : "남"}">
    <input type="hidden" name="birth" value="${sBirthDate}">
    <section class="yd-reservation clearfix">
        ...
        <div class="ydr-tit">진주남강유등축제 등(燈)공모대전 신청</div>
        <div class="ydr-form-list" id="origin">
            <div class="ydr-form-item">
                ...
                <input type="text" placeholder="이름을 입력해주세요." id="name" name="name" value="${sName}" required>
            </div>
            <div class="ydr-form-item">
                <p class="ydr-form-tit">전화번호를 입력해주세요.<span class="tomato">*필수</span></p>
                <input type="text" placeholder="-없이 입력해주세요. 예)01023456789" value="${sMobileNo}" name="phone" class="onlyNumber" inputmode="numeric" required>
            </div>
            <div class="ydr-form-item">
                <p class="ydr-form-tit">이메일을 입력해주세요.<span class="tomato">*필수</span></p>
                <input type="email" placeholder="연락 가능한 이메일을 입력해 주세요." value="" name="email" class="" inputmode="email" required>
            </div>
            <div class="ydr-form-item">
                <h6 class="others">신청서 파일 제출</h6>
                <p class="ydr-form-tit">1. 출품서 및 출품원서<span class="tomato">*필수</span></p>
                <input type="hidden" name="file1" class="hidden1" value="">
                <input type="hidden" name="file1name" class="hidden2" value="">
                <div>
                    <input type="file" class="postcode" onchange="fileCheck(this)">
            ...
            <div class="ydr-form-item">
                ...
                <input type="hidden" name="file2" class="hidden1" value="">
                <input type="hidden" name="file2name" class="hidden2" value="">
                <div>
                    <input type="file" class="postcode" onchange="fileCheck(this)">
                    <button type="button" class="post-button" onclick="justSubmit(this)">제출</button>
                </div>
            ...
            <div class="ydr-form-item">
                ...
                <label class="privacy-agree">
                    <input type="checkbox" id="privacy-chk"> 개인정보 수집 및 이용 안내 동의
                </label>
            </div>
        </div>
        ...
        <div id="next" class="ydr-form-item-last">
            ...
            <p>신청자 <text id="sign">${sName}</text></p>
        </div>
        <button class="ydr-btn a-alone form-btn" type="submit">신청하기</button>
    </section>
</form>
<jsp:include page="/loading"/>
<script>
